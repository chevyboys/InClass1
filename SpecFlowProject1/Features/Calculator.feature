...
Scenario: Heber assignment 1
	Given the first number is 100
	When operation add is done to the number 50
	And operation add is done to the number 80
...
Scenario: Heber assingment 3
	...
	And operation add is done to the number 80
	And operation add is done to the number 80
	And operation divide is done to the number 10
	Then the result should be 31

 
Scenario: Heber assignment 4
	Given the first number is 100
	When operation divide is done to the number 50
	And operation subtract is done to the number 2
	And operation add is done to the number 10
	And operation Remainder is done to the number 3
